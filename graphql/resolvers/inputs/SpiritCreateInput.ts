...
import { IngredientCreateNestedManyWithoutSpiritInput } from "../inputs/IngredientCreateNestedManyWithoutSpiritInput";
...
@TypeGraphQL.InputType("SpiritCreateInput", {
  isAbstract: true
})
export class SpiritCreateInput {
  ...
  Ingredient?: IngredientCreateNestedManyWithoutSpiritInput | undefined;
}
